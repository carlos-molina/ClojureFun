...
As explained in [A history of Clojure, Rich Hickey, Proc. of the ACM on Programming Languages, N.71, V.4 2020.](https://doi.org/10.1145/3386321 "Rich Hickey"), clojure is a dialect of List and is implemented and runs on top of the Java VM. From this position, it can interact with and take advantage of Java libraries. With these features, it has been welcome in industries as diverse as finance, climate science, retail, databases, analytics, publishing, healthcare, advertising, genomics and otheres where the programmer needs to control concurrency. In publishing for example, concurrency materialises when co-authors are allowed to edit a documents simultaneously.
